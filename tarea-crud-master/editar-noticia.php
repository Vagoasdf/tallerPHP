...
$id=($_GET['id']);
$query = $db->query("SELECT * FROM noticias where `id_noticia`='$id'  ");
...
<body>
    ...
    <div class="row justify-content-md-center mt-5">
      <div class="col-sm-8">
        ...
        <!--Me dio lata usar el ejemplo de esto en MySQLi. Suelo usar PDO por recomendación y por la obsolencia de MySQLi. ejemplode MySQLi en el siguiente trabajo-->
      </div>
    </div>
  </div>
</body>
